/**
 * Generates the prompt for depth extraction.
 *
 * A primary reasoning agent identified this source as worth investigating.
 * The extraction agent's job: return structured findings the primary agent
 * can use without needing the full text.
 */
